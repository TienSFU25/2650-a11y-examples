These examples were compiled mostly from MDN's resources. The basic idea is to test with a Screen reader: compare `*non-accessible.html` vs `*accessible.html`
